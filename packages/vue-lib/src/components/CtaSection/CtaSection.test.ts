...
describe("CtaSection", () => {
  it("renders the title", () => {
    const wrapper = mount(CtaSection, {
      props: { config: makeCtaConfig({ title: "Join Us" }) },
    });
  ...
  it("renders the body", () => {
    const wrapper = mount(CtaSection, {
      props: { config: makeCtaConfig({ body: "We help you ship." }) },
    });
  ...
  it("renders the link label", () => {
    const wrapper = mount(CtaSection, {
      props: { config: makeCtaConfig({ label: "Get Started" }) },
    });
  ...
  it("link href matches config.route", () => {
    const wrapper = mount(CtaSection, {
      props: { config: makeCtaConfig({ route: "/contact" }) },
    });
