  ...
  <div class="welcome">
    ...
    <div class="welcome-section">
      ...
      <ul>
        ...
        <li><strong>Docs</strong> — auto-generated API documentation from the component's props and emits</li>
      </ul>
    </div>
    ...
    <div class="welcome-section">
      ...
      <pre class="welcome-code">import { /* components */ } from '@m2s2/vue-lib';</pre>
    ...
    <div class="welcome-section">
      ...
      <table class="welcome-table">
        ...
        <tbody>
          ...
          <tr><td>Dialog</td><td><code>Dialog</code></td><td>Centered modal with configurable action buttons</td></tr>
          <tr><td>Panel</td><td><code>Panel</code></td><td>Slide-in side panel (left or right) with optional slot content and footer actions</td></tr>
