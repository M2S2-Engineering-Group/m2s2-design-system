...
describe("CtaSection", () => {
  it("renders the title", () => {
    render(
      <CtaSection config={makeCtaConfig({ title: "Get Started Today" })} />,
    );
    expect(
  ...
  it("renders the body text", () => {
    render(
      <CtaSection
        config={makeCtaConfig({ body: "Join thousands of users." })}
      />,
    );
  ...
  it("renders the link with the correct href", () => {
    render(
      <CtaSection
        config={makeCtaConfig({ route: "/signup", label: "Sign Up Free" })}
      />,
    );
