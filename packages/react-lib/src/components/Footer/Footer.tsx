import { FooterConfig } from '@m2s2/models';
import './Footer.scss';
...
function SocialIcon({ type }: { type: string }) {
  if (type === 'github') {
    return (
      <svg className="social-icon" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor">
  ...
  if (type === 'linkedin') {
    return (
      <svg className="social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor">
