...
export const Default: Story = {
  args: { variant: "default", featured: false, children: <Content /> },
};
export const Raised: Story = {
  args: { variant: "raised", featured: false, children: <Content /> },
};
export const Accent: Story = {
  args: { variant: "accent", featured: false, children: <Content /> },
};
export const Featured: Story = {
  args: { variant: "default", featured: true, children: <Content /> },
};
