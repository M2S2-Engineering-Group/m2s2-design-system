...
export const States: Story = {
  ...
  render: () => (
    <div style={DEMO_STYLES}>
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        {label("Idle")}
        <LoadingButton style={primary} loading={false}>
          Save Changes
        </LoadingButton>
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        {label("Loading")}
        <LoadingButton style={primary} loading={true} loadingText="Saving…">
          Save Changes
        </LoadingButton>
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <LoadingButton style={danger} loading={true} loadingText="Deleting…">
          Delete Record
        </LoadingButton>
      </div>
    </div>
  ...
  render: () => (
    <div style={DEMO_STYLES}>
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <LoadingButton style={primary} loading={true}>
          Save Changes
        </LoadingButton>
      </div>
    </div>
