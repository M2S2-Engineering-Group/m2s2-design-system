    ...
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
      <div className="welcome">
        <div className="welcome-hero">
          ...
          <p className="welcome-subtitle">
            ...
            <a href="https://m2s2.io" target="_blank" rel="noopener">
              M²S² Engineering Group
            </a>{" "}
            — production-ready UI components built with React 18, hooks-first
        ...
        <div className="welcome-section">
          ...
          <p>
            Use the <strong>sidebar</strong> to navigate between components.
            Each component has:
          </p>
          <ul>
            <li>
        ...
        <div className="welcome-section">
          ...
          <div className="welcome-themes">
            {[
              {
                label: "M²S² Default",
                bg: "linear-gradient(135deg, #3b0764, #22d3ee)",
              },
              {
                label: "Ocean Blue",
                bg: "linear-gradient(135deg, #0369a1, #f472b6)",
              },
              {
                label: "Emerald",
                bg: "linear-gradient(135deg, #065f46, #818cf8)",
              },
              {
                label: "Sunset",
                bg: "linear-gradient(135deg, #c2410c, #f43f5e)",
              },
              {
                label: "Midnight",
                bg: "linear-gradient(135deg, #3730a3, #fbbf24)",
              },
            ].map(({ label, bg }) => (
              <div
                key={label}
          ...
          <p style={{ marginTop: 16 }}>
            ...
            light mode. Or visit <strong>Brand Configurator</strong> in the
            sidebar to set your own colors.
          </p>
        </div>
        ...
        <div className="welcome-section">
          ...
          <pre className="welcome-code">
            {"import { /* components */ } from '@m2s2/react-lib';"}
          </pre>
          ...
          <table className="welcome-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Responsive top navigation with brand, links, dropdowns, and
                  auth state
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>PanelProvider</td>
                <td>
                  <code>PanelProvider / usePanelContext</code>
                </td>
                <td>
                  Slide-in side panel (left or right) with optional content and
                  footer actions
                </td>
              </tr>
              <tr>
