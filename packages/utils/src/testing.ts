...
export const makeBlogCardConfig = (
  overrides?: Partial<BlogCardConfig>,
): BlogCardConfig => ({
  slug: "my-post",
  title: "My First Post",
  date: "2024-06-15",
...
export const makeFeatureCardConfig = (
...
export const makeNavbarButton = (
  overrides?: Partial<NavbarButton>,
): NavbarButton => ({
  id: "btn-1",
  title: "Home",
  href: "/",
...
export const makeNavbarLoginButton = (
  overrides?: Partial<NavbarLoginButton>,
): NavbarLoginButton => ({
  dropdownItems: [],
  ...overrides,
});

export const makeNavbarConfig = (
...
export const makeSectionHeaderConfig = (
  overrides?: Partial<SectionHeaderConfig>,
): SectionHeaderConfig => ({
  label: "Section Label",
  ...overrides,
});

export const makePageHeaderConfig = (
  overrides?: Partial<PageHeaderConfig>,
): PageHeaderConfig => ({
  title: "Page Title",
...
export const makeM2S2DialogData = (
  overrides?: Partial<M2S2DialogData>,
): M2S2DialogData => ({
...
export const makeM2S2PanelData = (
  overrides?: Partial<M2S2PanelData>,
): M2S2PanelData => ({
  title: "Panel Title",
...
export const makeFooterSocialLink = (
  overrides?: Partial<FooterSocialLink>,
): FooterSocialLink => ({
  type: "github",
